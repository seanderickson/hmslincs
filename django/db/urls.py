...
urlpatterns = patterns('',
    ...
    url(r'^sm/(?P<facility_id>\d+)-(?P<salt_id>\d+)%s$', 'db.views.smallMoleculeDetail', name="sm_detail"),
    url(r'^sm/(?P<facility_salt_batch_id>\d+-\d+-\d+)/?$', 
        'db.views.small_molecule_batch_redirect', name="sm_batch_redirect"),
    url(r'^sm/(?P<facility_salt_id>\d+-\d+)(-\d+)?/?$', 
        'db.views.smallMoleculeDetail', name="sm_detail"),
    ...
    url(r'^cells/(?P<facility_id>\d+)-(?P<batch_id>\d+)/?$', 
        'db.views.cell_batch_redirect', name="cell_batch_redirect"),
    url(r'^cells/(?P<facility_id>\d+)(-\d+)?/?$', 
        'db.views.cellDetail', name="cell_detail"),
    url(r'^antibodies/$','db.views.antibodyIndex', name="listAntibodies"),
    url(r'^antibodies/(?P<facility_id>\d+)-(?P<batch_id>\d+)/?$', 
        'db.views.antibody_batch_redirect', name="antibody_batch_redirect"),
    url(r'^antibodies/(?P<facility_id>\d+)(-\d+)?/?$', 
